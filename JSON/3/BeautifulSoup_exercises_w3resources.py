...
#Retrieve all the paragraph tags from a given html document
...
##Get the number of paragraph tags of a given html document
...
#Extract the text in the first paragraph tag of a given html document
...
#Find the length of the text of the first <h2> tag of a given html document
...
#Find the text of the first <a> tag of a given html text
...
#Extract all the URLs from the webpage python.org that are nested within <li> tags from
...
#Find all the h2 tags and list the first four from the webpage python.org
...
#List of all the h1, h2, h3 tags from the webpage python.org
...
#Extract all the text from a given web page
...
#Print the names of all HTML tags of a given web page going through the document tree
...
#Retrieve children of the html tag from a given web page
...
#Retrieve all descendants of the body tag from a given web page
...
#Retrieve the HTML code of the title, its text, and the HTML code of its parent
...
# Print content of elements that contain a specified string of a given web page
...
#Print the element(s) that has a specified id of a given web page
...
#Parse tree into a nicely formatted Unicode string, with a separate line for 
#each HTML/XML tag and string
...
#Find tag(s) beneath other tag(s) in a given html document
...
#Find tag(s) directly beneath other tag(s) in a given html document
...
#Find the siblings of tags in a given html document
...
#Find tags by CSS class in a given html document
...
#Change the tag’s contents and replace with the given string
...
#Add to a tag’s contents in a given html document
...
#Insert a new text within a url in a specified position
...
#Insert tags or strings immediately before specified tags or strings
...
#Insert tags or strings immediately after specified tags or strings
...
#Remove the contents of a tag in a given html document
...
#Extract a tag or string from a given tree of html document
...
# Remove a tag from a given tree of html document and destroy it and its contents 
...
#Remove a tag or string from a given tree of html document and replace it with the given tag or string 
...
#Wrap an element in the specified tag and create the new wrapper 
...
#Replace a given tag with whatever’s inside a given tag 
