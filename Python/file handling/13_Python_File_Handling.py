...
Code Challenge
  ...
  Problem Statement:
      ...
      Write a program that will mine the dictionary anagram.txt for anagrams.  
      There are several ways to do this, and some of them take much longer than others.  
      You might want to practice with the initial parts of anagram.txt.  
